...
class Trader:
    ...
    def trade_options(self, state: TradingState, memory: dict[str, Any], spot: float | None) -> dict[str, list[Order]]:
        ...
        DIR_CAP = 150
        MM_CAP = 80
        DELTAS = {4000: np.float64(0.23774629481207465),
                  4500: np.float64(0.14246443674170994),
                  5000: np.float64(0.04784763426891344),
                  5100: np.float64(0.030644320616160303),
                  5200: np.float64(0.016950793605233574),
                  5300: np.float64(0.007841606731297765),
                  5400: np.float64(0.0024046544215749767),
                  5500: np.float64(0.0008961853225561565)}
        ...
        for strike in STRIKES[:-3]:
            ...
            delta = spot / 5250 #self.bs_delta(spot, strike, t)
